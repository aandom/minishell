...
SRC = 	builtins.c command.c command_arg.c command_utils.c env_pointer.c envar.c \
		error.c execute.c execute_utils.c exit_shell.c expand.c expand_utils.c   \
		expand_var.c expand_var_utils.c free_iofds.c ft_cd.c ft_cd2.c ft_cd_utils.c \
		ft_echo.c ft_env.c ft_exit.c ft_exit_utils.c ft_export.c ft_export_utils.c \
		ft_free.c ft_free_new.c ft_heredoc.c ft_heredoc_utils.c ft_input.c ft_iofds.c \
