...
static int	execute_cmd_helper(t_data *data, t_cmd *cmd, t_exno *ex_no)
{
	int	res;
...
static int	execute_cmd(t_data *data, t_cmd *cmd, t_exno *ex_no)
{
	int	res;
...
static int	create_forks(t_data *data, t_exno *ex_no)
{
	t_cmd	*cmds;
	int		a;
